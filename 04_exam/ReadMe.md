...
Экзаменационная задача выбирается обучающимся случайным образом из набора экзаменационных задач и на её решение отводится 30 минут. Задачи решаются в системе Яндекс.Контест и оцениваются от 0 до 100 баллов пропорционально количеству тестов пройденных решением.
